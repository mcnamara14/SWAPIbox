# SWAPIbox
This application fetches Star Wars API data, displays crawl text from a random movie on load and renders Star Wars cards with cleaned data on them according to the filter that was clicked. 
